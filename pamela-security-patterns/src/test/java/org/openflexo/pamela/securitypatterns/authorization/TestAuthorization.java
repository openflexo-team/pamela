...
public class TestAuthorization extends TestCase {
	...
	public void testPatternAnalysis() throws Exception {
		PamelaMetaModel metaModel = new PamelaMetaModel(PamelaMetaModelLibrary.retrieveMetaModel(Subject.class, Resource.class));
		assertEquals(1, metaModel.getPatternDefinitions(AuthorizationPatternDefinition.class).size());
		AuthorizationPatternDefinition pattern = metaModel.getPatternDefinitions(AuthorizationPatternDefinition.class).get(0);
		...
		AuthorizationPatternDefinition.SubjectAccessMethodWrapper wrapper = pattern.getSubjectAccessMethods()
				.get(Subject.class.getMethod("getResource", String.class));
		...
		assertEquals(PermissionChecker.class.getMethod("check", String.class, int.class, String.class, String.class),
				pattern.getCheckMethod());
	}
	...
	public void testInstanceDiscovery() throws Exception {
		...
		AuthorizationPatternDefinition patternDefinition = metaModel.getPatternDefinitions(AuthorizationPatternDefinition.class).iterator()
				.next();
		...
		assertEquals(1, model.getPatternInstances(patternDefinition).size());
		patternInstance = (AuthorizationPatternInstance<Subject, Resource, PermissionChecker>) model.getPatternInstances(patternDefinition)
				.iterator().next();
