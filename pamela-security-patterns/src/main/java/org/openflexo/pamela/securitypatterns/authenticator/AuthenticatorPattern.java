...
import org.openflexo.pamela.securitypatterns.authenticator.exceptions.InconsistentAuthenticatorEntityException;
import org.openflexo.pamela.securitypatterns.authenticator.exceptions.InconsistentSubjectEntityException;

/**
 * This class represents an instance of an <code>Authenticator Pattern</code>. An instance is uniquely identified by the
 * <code>patternID</code> field of associated annotations.<br>
 * It has the responsibility of:
 * <ul>
 * <li>Creating and saving the {@link AuthenticatorEntity} and all {@link AuthenticatorSubjectEntity} relevant to this pattern.</li>
 * <li>Throwing {@link InconsistentAuthenticatorEntityException} and {@link InconsistentAuthenticatorEntityException} when the associated
 * entity instanciation has failed.</li>
 ...
 * <li>Relaying to the relevant entities the checks and execution of methods.</li>
 * </ul>
 *
 * @author C. SILVA
 */
...
public class AuthenticatorPattern extends AbstractPattern {
	 ...
	 *             In case of inconsistent subject or authenticator definition
	 */
	@Override
	...
	/**
	 * Method called before every <code>Authenticator Pattern</code> class method. It relays the check and execution to the relevant entity.
	 * 
	 * @param instance
	...
	/**
	 * Relay the instance discovery to the relevant entity. This method is to be called when a new instance is discovered by the
	 * {@link PatternContext} instance.
	 * 
	 * @param instance
	 *            instance to discovered.
	 * @param klass
	 *            Pattern-related class of identified im the class tree of <code>instance</code>
	 */
	@Override
	...
	/**
	 * Method called after every <code>Authenticator Pattern</code> class method. It relays the check to the relevant entity.
	 * 
	 * @param instance
	 *            Object on which the method is called
	 * @param method
	 ...
	 *            Pattern-related class of identified im the class tree of <code>instance</code>
	 * @param returnValue
	 *            Return value of the <code>method</code> invoke
	 * @param args
	...
	/**
	 * @return the {@link HashMap} mapping {@link AuthenticatorSubject} annotated class with the corresponding
	 *         {@link AuthenticatorSubjectEntity}
	 */
	...
	/**
	 * Instantiate an {@link AuthenticatorEntity} with the given class. This method is to be called when parsing the
	 * {@link AuthenticatorSubject} annotated class with the return type of the {@link AuthenticatorGetter} annotated method.
	 * 
	 * @param authenticatorClass
	 *            {@link Authenticator} annotated class.
	 * @throws InconsistentAuthenticatorEntityException
	 *             In case of inconsistent authenticator definition
	 */
	void attachAuthenticatorFromAuthenticatorGetter(Class authenticatorClass) throws InconsistentAuthenticatorEntityException {
		if (this.authenticator == null) {
			Class auth = null;
			for (Class klass : PatternUtils.getClassHierarchy(authenticatorClass)) {
			...
			if (auth == null) {
				throw new InconsistentAuthenticatorEntityException(
						"Missing annotations in " + authenticatorClass.getSimpleName() + "Authenticator definition with ID " + this.id);
			}
	 ...
	 * 
	 * @param instance
	 *            Object on which the authentication is to be performed on.
	 * @param idProofSetter
	 *            Setter method of the <code>Proof of Identity</code>
	 * @param args
	 *            Ordered list of <code>instance</code> getters of the <code>request</code> method parameters
	 * @param authenticatorGetter
	 *            Getter method of the <code>instance</code> authenticator instance
	 * @param authenticatorSubjectEntity
	 *            {@link AuthenticatorSubjectEntity} wrapping the instance
	 * @throws InvocationTargetException
	 *             if an error occurred when internally invoking a method
	 * @throws IllegalAccessException
	 *             if an error occurred when internally invoking a method
	 */
	void performAuthentication(Object instance, Method idProofSetter, Method[] args, Method authenticatorGetter,
			AuthenticatorSubjectEntity authenticatorSubjectEntity) throws InvocationTargetException, IllegalAccessException {
	 ...
	 * @throws ModelDefinitionException
	 *             In case of inconsistent subject definition.
	 */
	private void attachSubject(Class klass) throws ModelDefinitionException {
		...
		if (subject.isComplete()) {
			...
			throw new InconsistentSubjectEntityException(
					"Missing annotations in " + klass.getSimpleName() + "Authenticator subject definition with ID " + this.id);
		}
	}
	 ...
	 *            Pattern-related class of identified im the class tree of <code>instance</code>
	 * @param args
	 *            Argument passed to the to-be-called methods
	 */
