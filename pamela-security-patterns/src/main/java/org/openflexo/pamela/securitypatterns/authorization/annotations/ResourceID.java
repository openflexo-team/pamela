 ...
 * This annotation is to be put on a method of a {@link ProtectedResource} annotated class allowing
 * for the retrieval of a resource identifier.<br>
 * A {@link ProtectedResource} annotated class can have an multiple (but at least one) {@link ResourceID} annotated method,
