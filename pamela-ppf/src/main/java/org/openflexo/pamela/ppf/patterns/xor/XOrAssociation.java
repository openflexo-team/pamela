...
/**
 * This annotation is used in the definition of XOrAssociation
 *
...
public @interface XOrAssociation {
	/**
	 * @return The unique identifier of the associated XOrAssociation
	 */
	String patternID();
}
