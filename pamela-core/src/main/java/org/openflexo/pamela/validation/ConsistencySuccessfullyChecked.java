...
public class ConsistencySuccessfullyChecked<R extends ValidationRule<R, V>, V extends Validable> extends InformationIssue<R, V> {
	...
	private static final Logger logger = Logger.getLogger(ConsistencySuccessfullyChecked.class.getPackage().getName());

	public ConsistencySuccessfullyChecked(V anObject, String aMessage) {
		super(anObject, aMessage);
	}

	@Override
	public String toString() {
		return "VALIDATION / SUCCESSFULLY CHECKED:    " + getMessage();
	}
