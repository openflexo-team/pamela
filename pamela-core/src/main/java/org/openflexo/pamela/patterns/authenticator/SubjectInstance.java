...
class SubjectInstance {
     ...
     * @param method Method which will be invoked
     */
     ...
     * @param method Method which will be invoked
     * @param returnValue returnValue of the method
     */
     ...
     * @param proof valid <code>Proof of Identity</code>
     */
     ...
     * @param returnValue Return Value of the invoked method
     */
     ...
     * @param method Method to be invoked after check
     */
