...
/**
 * The {@link ModelFactory} is responsible for creating new instances of PAMELA
 * entities.<br>
 * 
 * This class should be considered stateless, regarding to the state of handled
 * instances.<br>
 * 
 * Note that a {@link ModelFactory} might refer to an {@link EditingContext}.
 * When so, new instances are automatically registered in this
 * {@link EditingContext}.
 * 
 * @author sylvain
 * 
...
public class ModelFactory implements IObjectGraphFactory {
     ...
     * contained in related class All property should be annotated with a @Embedded
     ...
     * Return pasted objects (a single object for a single contents clipboard,
     * and a list of objects for a multiple contents)
     * 
     * @param clipboard
     * @param context
     * @return
    ...
    /**
     * Paste supplied clipboard in context object for supplied property at
     * specified pasting point<br>
     * Return pasted objects (a single object for a single contents clipboard,
     * and a list of objects for a multiple contents)
     * 
     * @param clipboard
    ...
    /**
     * Hook to detect an object deserialization (called just after instance has
     * been created)<br>
    ...
    /**
     * Hook to detect an object deserialization (called at the end of whole
     * object graph deserialization)<br>
     * Default implementation silently returns
     * 
     * @param newlyCreatedObject
     * @param implementedInterface
