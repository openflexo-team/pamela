...
public abstract class AbstractModelSerializer implements ModelSerializer {
	...
	protected SerializationPolicy policy;

	public AbstractModelSerializer(ModelFactory modelFactory) {
		this(modelFactory, SerializationPolicy.PERMISSIVE);
	}

	public AbstractModelSerializer(ModelFactory modelFactory, SerializationPolicy policy) {
