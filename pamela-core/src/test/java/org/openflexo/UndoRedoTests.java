...
public class UndoRedoTests extends AbstractPAMELATest {
    ...
    public void testAttributesUndoRedo() throws Exception {
        final String defaultValue = (String) modelContext.getModelEntity(TestModelObject.class).getModelProperty(TestModelObject.NAME).getDefaultValue(factory);
